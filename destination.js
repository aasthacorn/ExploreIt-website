...
function createCard(item) {
  ...
  price.innerHTML = `<span>Rs.${item.estimatedCost}</span> per person`;
...
function displayDestinationDetails(imgObj, city) {
  ...
  let price = document.createElement("p");
  price.innerHTML = `It would take about <span>Rs.${city.estimatedCost}</span> per person to travel to ${city.name}`;
